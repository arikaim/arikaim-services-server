...
from core.access.auth_error import AuthError
...
class Access:
    ...
    def load_moddleware_class(module_name, class_name):
        module = importlib.import_module('core.access.middleware.' + module_name,class_name)
        return getattr(module,class_name)


    @staticmethod
    def load_provider_class(module_name, class_name):
        module = importlib.import_module('core.access.providers.' + module_name,class_name)
        return getattr(module,class_name)